...
public class BaseAction {
	 ...
	 * @param x，y
	 */
	public void pointOption(int x,int y) {
	...
	public void longPresspoint(int x,int y) {
		LongPressOptions longPressOptions2 = LongPressOptions.longPressOptions();
		longPressOptions2.withPosition(PointOption.point(x, y));
		action.longPress(longPressOptions2).release().perform();
	}
	...
	public void longmove(int x1,int y1,int x2,int y2) {
		...
		LongPressOptions longPressOptions2 = LongPressOptions.longPressOptions();
		longPressOptions2.withPosition(PointOption.point(x1, y1));

		action.longPress(longPressOptions2).moveTo(PointOption.point(x2,y2)).release().perform();
	}
/**
 * 多点触控功能实现
 * @param x1
 ...
 */
	...
	public String getText() {
		return driver.findElementById("com.example.shoujiedemo:id/ed_article_content").getText();
	}
}
